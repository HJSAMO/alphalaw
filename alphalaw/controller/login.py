...
def login_required(f):
    ...
    def decorated_function(*args, **kwargs):
        try:
            ...
            Log.error("Alphalaw error occurs : %s" % 
                      str(e))
            raise e
...
@alphalaw.route('/user/login', methods=['POST'])
def login():
