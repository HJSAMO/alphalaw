# -*- coding: utf-8 -*-
"""
    alphalaw.controller.register_user
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    사용자 등록 모듈.
"""
...
@alphalaw.route('/user/regist', methods=['POST'])
def register_user():
    """사용자 등록을 위한 함수"""
...
@alphalaw.route('/user/<username>', methods=['POST'])
@login_required
...
@alphalaw.route('/user/check_name', methods=['POST'])
def check_name():
